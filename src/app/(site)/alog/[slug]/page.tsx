			...
			<div className="max-w-[760px] mx-auto px-4 xl:px-0">
				<div className="flex items-center justify-between gap-4 mb-8">
					...
					<a
						...
						className="font-mono text-[12px] uppercase tracking-[-2%] text-brand-glow hover:text-brand-soft transition-colors duration-300"
					>
						View as .md
					</a>
				</div>
				...
				<header className="mb-10 pb-8 border-b border-[#292929]">
					<div className="flex items-center gap-3 font-mono text-[11px] md:text-[12px] uppercase tracking-[-1%] text-[#FFFFFF66] mb-4">
						<span className="text-brand-glow">{doc.category}</span>
									...
									{doc.relatedDocs.map((docLink) => (
										<li key={docLink.href}>
											<a
												...
												className="text-[14px] text-brand-glow hover:text-brand-soft underline underline-offset-2"
											>
												{docLink.label}
											</a>
										</li>
