					...
					{posts.map((post) => (
						...
						>
							...
							<div className="flex flex-col gap-3 min-w-0">
								<h2 className="font-sans text-[18px] md:text-[20px] tracking-[-2%] leading-[1.25] font-normal text-white group-hover:text-brand-glow transition-colors duration-300">
									{post.title}
								</h2>
								{post.description && (
