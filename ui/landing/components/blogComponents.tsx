...
export const mdxComponents = {
		...
		if (isExternal) {
			return (
				<a
					...
					className="font-normal text-brand-glow hover:text-brand-soft no-underline hover:underline decoration-brand-glow/60 decoration-1 underline-offset-4 transition-colors"
					{...props}
				>
					{children}
				</a>
	...
	blockquote: ({
		...
		<blockquote
			className="border-l-2 border-brand-glow bg-brand-glow/5 py-4 pl-4 pr-4 not-italic font-normal text-[#FFFFFF99] [&>p]:my-0 [&>p]:text-[#FFFFFF99] [&>p+p]:mt-3 [&>p]:before:content-none [&>p]:after:content-none"
			{...props}
		>
			{children}
		</blockquote>
