...
function SubscriptionCard() {
	return (
		<div className="flex flex-none flex-col overflow-hidden rounded-lg border border-brand-glow/30 bg-brand-glow/8 sm:w-[206px]">
			<div className="flex items-baseline justify-between gap-2 border-brand-glow/15 border-b px-[11px] py-[9px]">
				<span className="font-mono text-[11px] text-[#E5E5E5]">
					subscription
				</span>
				<span className="font-mono text-[9px] text-brand-glow">monthly</span>
			</div>
			<div className="flex flex-1 flex-col gap-[5px] px-[11px] py-2.5">
				<div className="mb-px font-mono text-[9px] text-brand-glow/60 uppercase tracking-[0.08em]">
					invoice
				</div>
			...
			<div className="flex justify-between gap-2 border-brand-glow/15 border-t px-[11px] py-[9px] font-mono text-[11px] text-[#E5E5E5]">
				<span>total</span>
				<span>$2,990</span>
			</div>
		</div>
	...
	return (
		<div className="flex h-11 items-center justify-between gap-3 rounded-lg border border-[#292929] bg-[#141414] px-3 py-[11px]">
			...
			<span className="font-mono text-[10px] text-[#FFFFFF66]">
				100k <span className="text-brand-glow">pooled credits</span>
			</span>
		</div>
	);
}
			...
			<div className="mb-2 flex items-baseline justify-between gap-1.5">
				...
				<span
					className={`font-mono text-[9px] ${
						tierAccent ? "text-brand-glow" : "text-[#FFFFFF99]"
					}`}
				>
					{tier}
				</span>
