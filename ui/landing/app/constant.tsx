...
export const IconCTAStart = (props: SvgIconProps) => (
	...
	>
		...
		<path d="M15.776 11.2439H17.2865V12.7544H15.776V11.2439Z" fill="var(--color-brand-glow)" />
		<path d="M11.2445 11.2439H12.755V12.7544H11.2445V11.2439Z" fill="var(--color-brand-glow)" />
		<path
		...
		<path
			...
			fill="var(--color-brand-glow)"
		/>
		<path d="M14.2655 9.7334H15.776V11.2439H14.2655V9.7334Z" fill="var(--color-brand-glow)" />
		<path d="M14.2655 14.2649H15.776V12.7544H14.2655V14.2649Z" fill="var(--color-brand-glow)" />
		<path d="M12.755 8.22291H14.2655V9.7334H12.755V8.22291Z" fill="var(--color-brand-glow)" />
		<path d="M12.755 15.7754H14.2655V14.2649H12.755V15.7754Z" fill="var(--color-brand-glow)" />
		<motion.g
...
export const faqData = [
	{
		...
		answer:
			"No. Elegís un plan, un dominio y una plantilla. Cargás biografía, fotos y redes. GigBlade se encarga del hosting, la seguridad y el dominio. No tenés que configurar DNS ni certificados.",
	},
	{
		id: 7,
		question: "¿El dominio es mío o de la plataforma?",
		answer:
			"El dominio queda registrado y administrado por GigBlade, a nombre de la plataforma. Es parte del servicio, no un trámite que tengas que resolver en otro lado.\n\nLa renovación anual se cobra de forma transparente, al costo real, sin margen agregado.",
	},
	{
		id: 2,
		question: "¿Cómo llegan las solicitudes de booking?",
		answer:
			"Cada página tiene un formulario propio, protegido contra spam y bots. Quien te quiere contratar lo completa ahí.\n\nVos ves las solicitudes en tu panel. Dejan de llegar mezcladas entre Instagram y WhatsApp.",
	},
	{
		id: 3,
	...
	{
		id: 4,
		question: "¿Qué pasa si quiero irme de la plataforma más adelante?",
		answer:
			"Tu contenido te lo podés llevar. El dominio lo administra la plataforma mientras estés en el servicio; si te vas, coordinamos la salida para que no quedes sin presencia de un día para el otro.\n\nNo hay que desarmar hosting ni servidores: eso nunca fue tuyo que mantener.",
	},
	{
		id: 5,
		question: "¿En qué se diferencia de un armador de webs genérico?",
		answer:
			"Los temas están diseñados para la estética de DJs y eventos, no para cualquier negocio. El dominio, el hosting y la seguridad vienen incluidos.\n\nNo es un constructor donde tenés que elegir hosting, pelearte con el DNS o pagar el dominio en otro lado.",
	},
	{
		id: 6,
		question: "¿Cuánto cuesta?",
		answer:
			"Hay un solo plan todo incluido: US$ 65 al mes. Cubre hosting, seguridad, página y dominio propio.\n\nLa renovación anual del dominio se cobra aparte, al costo real, sin margen.",
	},
];
...
export const featuresData = [
	{
		...
		description:
			"Tu página vive en un dominio como djmarco.com. Lo registramos y renovamos nosotros, al costo real.",
		Icon: IconWebhooks,
	},
	{
		title: "Temas para DJs",
		description:
			"Catálogo visual pensado para DJs y eventos. No es un constructor genérico: la estética ya está resuelta.",
		Icon: IconVersioning,
	},
	{
		title: "Formulario de booking",
		description:
			"Un canal formal para productoras y clubes. Protegido contra spam y bots.",
		Icon: IconPlans,
	},
	{
		title: "Panel del DJ",
		description:
			"Cargás contenido y ves las solicitudes de booking. Sin entrar a un panel de hosting.",
		Icon: IconAnalytics,
	},
	{
		title: "Hosting en cache",
		description:
			"La página carga desde cache la mayor parte del tiempo. Rápida para quien te busca desde el celular.",
		Icon: IconTeam,
	},
	{
		title: "Seguridad incluida",
		description:
			"Protección de plataforma: ataques, formularios y datos aislados de otros DJs. Vos no lo configurás.",
		Icon: IconTopUp,
	},
	{
		title: "Sin saber de DNS",
		description:
			"No elegís hosting ni certificados. El dominio es parte del servicio, no un trámite aparte.",
		Icon: IconReact,
	},
	{
		title: "Un solo motor",
		description:
			"Todas las páginas corren sobre la misma infraestructura. Por eso el costo por DJ se mantiene bajo.",
		Icon: IconWebhooks,
	},
	{
		title: "Imagen profesional",
		description:
			"Un lugar propio frente a organizadores. Dejás de depender solo de Instagram para que te encuentren.",
		Icon: IconReferral,
	},
];
...
export const customerStoriesData: CustomerStory[] = [
	{
		...
		headline: {
			lead: "Una página propia",
			emphasis: "lista para clubes.",
		},
		stats: [
		...
		author: { name: "Nox", title: "Sets nocturnos" },
	},
	{
		slug: "firecrawl",
		name: "Firecrawl",
	...
	},
	{
		...
		glyphHeight: "95%",
		headline: {
			lead: "Estética de evento,",
			emphasis: "no de plantilla genérica.",
		},
		stats: [
			{ value: "1", label: "Tema de catálogo" },
			{ value: "0", label: "Builders genéricos" },
			{ value: "1", label: "Imagen propia" },
		],
		quote:
			"No es un armador de sitios para cualquier negocio. Los temas están pensados para DJs y eventos.",
		author: { name: "Luna", title: "DJ de festival" },
	},
	{
		slug: "t3-chat",
		name: "T3.chat",
		...
		headline: {
			lead: "Hosting, dominio y seguridad",
			emphasis: "en un solo plan.",
		},
		stats: [
			{ value: "$65", label: "Al mes, todo incluido" },
			{ value: "0", label: "Trámites de DNS" },
			{ value: "1", label: "Motor compartido" },
		],
		quote:
			"Pago la suscripción y me olvido de hosting, certificados y renovaciones raras. El dominio se cobra al costo, sin margen.",
		author: { name: "Residente", title: "DJ residente" },
	},
];
